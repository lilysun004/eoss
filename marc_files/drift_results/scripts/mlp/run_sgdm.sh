...
#SBATCH --mem=96G
#SBATCH -t 12:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/tdm_sgdm_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/tdm_sgdm_%j.err
...
/n/home06/mwalden/.conda/envs/eoss/bin/python config.py \
    ...
    --optimizer_name SGD-Momentum --lr 0.002 --batch_size 128 \
