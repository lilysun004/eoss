...
#SBATCH --mem=96G
#SBATCH -t 12:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/tdm_rmsprop_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/tdm_rmsprop_%j.err
...
/n/home06/mwalden/.conda/envs/eoss/bin/python config.py \
    ...
    --steps 80000 --track_from 75000 --track_until 80000 \
    --stop_loss None \
