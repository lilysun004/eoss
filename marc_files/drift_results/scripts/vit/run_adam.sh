...
#SBATCH --mem=96G
#SBATCH -t 24:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/tdv_adam_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/tdv_adam_%j.err
...
/n/home06/mwalden/.conda/envs/eoss/bin/python config.py \
    ...
    --optimizer_name Adam --lr 0.00002 --batch_size 128 \
