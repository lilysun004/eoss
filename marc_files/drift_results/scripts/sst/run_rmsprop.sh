...
#SBATCH --mem=96G
#SBATCH -t 12:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/tds_rmsprop_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/tds_rmsprop_%j.err
