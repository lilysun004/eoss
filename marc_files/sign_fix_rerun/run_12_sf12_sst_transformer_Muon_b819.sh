#!/bin/bash
#SBATCH -J sf12_sst_transformer_Muon_b819
...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/sf12_sst_transformer_Muon_b819_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/sf12_sst_transformer_Muon_b819_%j.err
