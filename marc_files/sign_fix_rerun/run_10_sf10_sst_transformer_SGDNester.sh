#!/bin/bash
#SBATCH -J sf10_sst_transformer_SGDNester
...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/sf10_sst_transformer_SGDNester_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/sf10_sst_transformer_SGDNester_%j.err
