#!/bin/bash
#SBATCH -J sf09_sst_transformer_Muon_b102
...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/sf09_sst_transformer_Muon_b102_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/sf09_sst_transformer_Muon_b102_%j.err
