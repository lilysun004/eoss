...
#SBATCH -t 08:00:00
#SBATCH --array=0-4
#SBATCH -o /n/home06/mwalden/eoss/marc_files/logs/nesterov_%a_%j.out
#SBATCH -e /n/home06/mwalden/eoss/marc_files/logs/nesterov_%a_%j.err
...
/n/home06/mwalden/.conda/envs/eoss/bin/python config.py \
    ...
    --results_subfolder marc_optimizer_sweep
