...
# OPTIMIZERS = [
#     ('Adam',         [3e-4,  1e-3,  3e-3],        {'beta1': 0.9, 'beta2': 0.999}),
#     ('Muon',         [0.002, 0.005, 0.01],        {'momentum': 0.95}),  # reduced from [0.02, 0.05, 0.1] — old LRs diverged
#     ('SGD',          [0.007, 0.015, 0.04],        {}),
#     ('SGD-Momentum', [0.004, 0.008, 0.02],        {'beta': 0.9}),
#     ('SGD-Nesterov', [0.004, 0.008, 0.02],        {'beta': 0.9}),
# ]
#
# jobs = []
...
if __name__ == '__main__':
    run_jobs(jobs, num_gpus=2, max_per_gpu=10)
